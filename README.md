...
The current version of XOM is 1.4.5 and is backwards compatible with all previous versions from 1.0 on. You should not need to recompile any code to upgrade to 1.4.5 XOM is believed to be quite stable and robust. Future releases should be backwards compatible with the 1.0 API for the foreseeable future.
