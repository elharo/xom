...
The current version of XOM is 1.4.0 and is backwards compatible with all versions of XOM from 1.0 to 1.3.9. You should not need to recompile any code to upgrade to 1.4.0. XOM is believed to be quite stable and robust. Future releases should be backwards compatible with the 1.0 API for the foreseeable future.
