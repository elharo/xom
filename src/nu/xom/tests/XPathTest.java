...
<x>4</x>
    ...
    public void testFranceschet1() throws ParsingException, IOException {
        ...
        try {
            Document doc = builder.build(
              "https://users.dimi.uniud.it/~massimo.franceschet/old.xpathmark/benchmark_canon.xml"
            );
            ...
            if (CITestUtil.shouldIgnore(ex)) {
                ...
                System.err.println("Skipping testFranceschet1: network unavailable");
                return;
            }
            throw ex;
        }
    ...
    public void testFranceschet2() throws ParsingException, IOException {
        ...
        try {
            ...
            if (CITestUtil.shouldIgnore(ex)) {
                // Skip test if network is unavailable in CI
                System.err.println("Skipping testFranceschet2: network unavailable");
                return;
            }
            throw ex;
        }
...
<div></div>
    ...
    public void testJaxenIntegrationTest() throws ParsingException, IOException {
        ...
        File jaxenBase = new File("build/jaxen-2.0.6");
