...
4. Properly implementing XPath 1.0 according to the specification.
...
* XML documents or XPath expressions that cause infinite loops in the parser or exponential performance problems.
