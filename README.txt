...
CLASSPATH. This archive is the file named something like xom-1.3.5.jar. 
(The version number may have changed if I've forgotten
to update this document.) You can either put it in your jre/lib/ext
directory, add xom-1.3.5.jar to your CLASSPATH environment variable, or
...
$ java -classpath xom-samples.jar:xom-1.3.5.jar nu.xom.samples.PrettyPrinter filename.xml
...
$ java -classpath xom-samples.jar:xom-1.3.5.jar:lib/xml-apis.jar:lib/xercesImpl.jar:lib/xalan.jar nu.xom.samples.PrettyPrinter filename.xml
...
=======================================================================
XOM is Copyright 2004, 2005, 2009, 2018, 2019, 2020 Elliotte Rusty Harold
