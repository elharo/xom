...
CLASSPATH. This archive is the file named something like xom-1.4.0.jar. 
(The version number may have changed if I've forgotten
to update this document.) You can either put it in your jre/lib/ext
directory, add xom-1.4.0.jar to your CLASSPATH environment variable, or
...
$ java -classpath xom-samples.jar:xom-1.4.0.jar nu.xom.samples.PrettyPrinter filename.xml
...
$ java -classpath xom-samples.jar:xom-1.4.0.jar:lib/xml-apis.jar:lib/xercesImpl.jar nu.xom.samples.PrettyPrinter filename.xml
...
that enables reproducible builds).
