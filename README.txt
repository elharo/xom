...
This archive is the file named something like xom-1.4.5.jar.
...
xom-1.4.5.jar to your CLASSPATH environment variable, or use the
...
$ java -classpath xom-samples.jar:xom-1.4.5.jar nu.xom.samples.PrettyPrinter filename.xml
